...
![](./analysis/output/cost.md)
![](./analysis/output/cost.csv)
![](./analysis/output/performance.md)
![](./analysis/output/correctness.md)
...
<p align="center">  
    <img src="./images/data-model_1-batch-ingestion-full-vs-incremental.png" width=80%>
</p>
